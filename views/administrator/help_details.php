        ...
        <div class="col-12 white-block">
            ...
            <div class="row mb-5 justify-content-center">
                ...
                <div class="col-md-8 text-center">
                    ...
                    <h4 class="text-primary m-0">objectif</h4>
                    <p class="objective text-primary"><?= $help->amount ?> XAF</p>
                    <h4 class="text-primary"><?= $help->unit_amount ?> XAF / membre</h4>
                    <h4 class="text-secondary m-0 mt-4">Contribution</h4>
