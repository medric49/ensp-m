    ...
    <div class="row mt-5">
        <div class="col-12 white-block mb-2">
            <div class="row">
                ...
                <h5 class="col">
                    <a class="black-link"
                       href="<?= Yii::getAlias("@administrator.borrowing_member") . "?q=" . $member->id ?>">Emprunts</a>
                </h5>
                <h5 class="col">
                    <a class="black-link"
                       href="<?= Yii::getAlias("@administrator.contribution_member") . "?q=" . $member->id ?>">Contributions</a>
                </h5>
            </div>
        </div>
