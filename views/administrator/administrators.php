                        ...
                        <div class="col-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Text -->
                                    <p class="card-text">
                                        <span>Pseudo : </span><span class="blue-text"><?= $administrator->username ?></span>
                                        <br
...
?>
<a href="<?= Yii::getAlias("@administrator.new_administrator") ?>" class="btn btn-primary btn-add"><i class="fas fa-plus"></i></a>
<?php
endif;